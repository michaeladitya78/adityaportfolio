...
export const projects: Project[] = [
    ...
    },
    {
        ...
        slug: 'repo-diary',
        title: 'Repo Diary',
        subtitle: 'Build in Public — Daily Dev Log Platform',
        category: 'fullstack',
        description: 'An open-source social platform built for engineering students in India to post 2-line daily build logs, grow a consistent GitHub-style activity history, and share a public profile with recruiters. Features GitHub OAuth, a live builders feed, searchable public profiles, and a clean logging interface — all designed to make "building in public" dead simple. Contributions welcome!',
        excerpt: 'Open-source daily dev log platform for engineering students to build in public and get placed.',
        accentColor: '#22c55e',
        initials: 'RD',
        tech: ['Next.js', 'TypeScript', 'Supabase', 'Tailwind CSS', 'GitHub OAuth', 'PostgreSQL'],
        year: 2026,
        featured: true,
        client: 'Open Source — Contributions Welcome',
        timeline: '1 week (MVP) • Actively maintained',
        role: 'Full-Stack Developer • Open-Source Maintainer',
        challenge: 'Engineering students struggle to demonstrate consistent progress to recruiters — most GitHub profiles are just graveyards of half-finished repos with no story behind the commits.',
        solution: 'Built a dead-simple logging interface where students post a 2-line daily log (what they built, learned, and plan next), generating a public, searchable profile at repodiary.com/username — shareable directly with recruiters.',
        highlights: [
            'Open source — anyone can contribute, fork, and self-host',
            'GitHub OAuth — zero friction sign-up, no email required',
            'Live builders feed showing real-time community activity',
            'Public profiles at repodiary.com/username for recruiter sharing',
            '30-second logging workflow: built → learned → next',
            'Built for engineering students across India',
        ],
        liveUrl: 'https://repo-diary.vercel.app',
        githubUrl: 'https://github.com/michaeladitya78/RepoDiary',
    },
];
