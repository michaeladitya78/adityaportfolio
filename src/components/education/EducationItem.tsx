...
export const EducationItem = ({ education, index, isVisible }: EducationItemProps) => {
  return (
    <Card 
      key={education.id} 
      className={`glass-card border-cursor-light-gray hover:border-accent/30 transition-all duration-700 ${
    ...
    >
      ...
      <CardContent>
        <div className="space-y-3">
          ...
          <div className="flex items-center gap-2 text-sm text-muted-foreground font-['SF_Pro_Text']">
