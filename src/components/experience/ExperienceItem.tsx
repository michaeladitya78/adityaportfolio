  ...
  return (
    ...
    >
      ...
      <div className="mb-1 flex flex-wrap items-center gap-2">
        <h3 className="text-xl font-semibold font-display">{experience.role}</h3>
        <Badge className="bg-gray-100 dark:bg-gray-800 text-accent hover:bg-gray-200 dark:hover:bg-gray-700 font-body">{experience.company}</Badge>
      </div>
      ...
      >
        {experience.duties.map((item, idx) => (
          ...
          >
            <div className={`h-2 w-2 rounded-full ${activeIndex >= index ? 'bg-accent' : 'bg-muted-foreground'} mt-2 flex-shrink-0`}></div>
