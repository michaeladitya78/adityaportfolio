      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredProjects.map((project, index) => (
            <div
              key={project.id}
              className={`glass-card group overflow-hidden border border-cursor-light-gray/30 hover:border-accent/30 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'
                }`}
              ...
              <div className="p-6">
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {project.tags.map((tag, idx) => (
                    <Badge
                      key={idx}
                      className="bg-gray-100 dark:bg-gray-800 text-accent hover:bg-gray-200 dark:hover:bg-gray-700 font-body"
                    >
                      {tag}
                    </Badge>
                  ))}
