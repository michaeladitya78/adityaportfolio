...
export default function Hero() {
  ...
  return (
    <section 
      id="home" 
      ref={(node) => {
        // @ts-ignore - This is a valid pattern to merge refs
        ref(node);
        // @ts-ignore
    ...
    >
      ...
      <div className="container px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <Badge 
            className={`bg-[#0A0A0A] text-[#0077FF] border border-[#0077FF]/30 hover:bg-[#121212] py-1.5 transition-all duration-700 transform hover:scale-105 ${
          ...
          <h1 
            className={`text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-6 transition-all duration-700 font-['SF_Pro_Display'] ${
              isVisible ? 'opacity-100' : 'opacity-0 translate-y-4'
            }`}
          ...
          <p 
            className={`text-lg sm:text-xl md:text-2xl text-[#F0F0F0] mb-8 max-w-3xl mx-auto transition-all duration-700 font-['SF_Pro_Text'] px-4 ${
              isVisible ? 'opacity-100' : 'opacity-0 translate-y-4'
            }`}
      ...
      <div 
        className={`absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce transition-all duration-700 hover:animate-none hover:scale-110 ${
