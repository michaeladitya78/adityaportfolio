...
export const projects: Project[] = [
    ...
    },
    {
        ...
        category: 'fullstack',
        description: 'A social platform built for engineering students in India to post 2-line daily build logs, grow a consistent GitHub-style activity history, and share a public profile with recruiters. Features GitHub OAuth, a live builders feed, searchable public profiles, and a clean logging interface — all designed to make "building in public" dead simple.',
        excerpt: 'Daily dev log platform for engineering students to build in public and get placed.',
        accentColor: '#22c55e',
        initials: 'RD',
