...
export default function LetsConnect() {
    ...
    const availableFor = [
        { icon: Briefcase, title: "Product Management roles", subtitle: "Junior to Mid-level", gradient: "from-blue-500 to-cyan-500" },
        { icon: Code, title: "Software Engineering positions", subtitle: "Full-stack, Backend, AI/ML", gradient: "from-purple-500 to-pink-500" },
        { icon: FileText, title: "Freelance projects", subtitle: "AI Chatbots, Web Dev, Product Consulting", gradient: "from-green-500 to-teal-500" },
        { icon: Users, title: "Contract work and consulting", subtitle: "Short-term and long-term engagements", gradient: "from-orange-500 to-red-500" },
        { icon: MessageCircle, title: "Collaborative open-source projects", subtitle: "Community-driven development", gradient: "from-indigo-500 to-purple-500" }
    ];

    return (
        <section id="lets-connect" ref={ref} className="section-container py-16 md:py-24 relative overflow-hidden">
            {/* Background elements */}
                ...
                >
                    <Card className="glass-card bg-gradient-to-br from-accent/5 to-tech-600/5 border-accent/20">
                        <CardContent className="p-6 md:p-8">
                            <p className="text-base md:text-lg text-center leading-relaxed font-body mb-6">
                            ...
                            <p className="text-base md:text-lg text-center text-muted-foreground leading-relaxed font-body">
                        ...
                        return (
                            ...
                            >
                                <CardContent className="p-6">
                                    ...
                                    <h3 className="text-base md:text-lg font-bold mb-1 font-display">{item.title}</h3>
